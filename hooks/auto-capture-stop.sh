...
reason = (
    ...
    "exposed or rendered, or deprecating/replacing a prior decision — you MUST record "
    "it NOW via a single `kg ingest` (do NOT ask permission; use the knowledge-graph "
    "skill's DO/DON'T rules "
